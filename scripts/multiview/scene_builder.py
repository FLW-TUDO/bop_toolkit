...
# TODO: make finction independent from GT values and reliant on scene from folder structure
...
def build_scene(mode, scene_id):
    ...
    gt = create_scene_gt(scene_id, out_path) # scene_id corresponds (initially, berore modifying images with cam id) to the requested images id
